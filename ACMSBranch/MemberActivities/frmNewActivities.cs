...
{
	/// <summary>
	/// Summary description for frmNewActivities.
	/// </summary>
	public class frmNewActivities : DevExpress.XtraEditors.XtraForm
	{
		...
		public frmNewActivities(string MembershipID)
		{
			//
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmNewActivities";
			this.Text = "Record Activity";
			this.Load += new System.EventHandler(this.frmNewActivities_Load);
		...
		private void frmNewActivities_Load(object sender, System.EventArgs e)
		{
			...
			private void btnSave_Click(object sender, System.EventArgs e)
			{
				...
				try
				{			   
				myCommon.Insert("TblMemberActivities",col,val);
				}
				catch (Exception ex)
				{
