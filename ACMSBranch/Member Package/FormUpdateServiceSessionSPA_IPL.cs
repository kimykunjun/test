...
namespace ACMS
{
	...
	public class FormUpdateServiceSessionSPA_IPL : System.Windows.Forms.Form
	{
		...
		private void Init()
		{
			...
			myMemberPackageIDLookupEditBuilder = new ACMS.XtraUtils.LookupEditBuilder.MemberPackageIDLookupEditBuilder(lkpEdtPackageID.Properties, myMembershipID, true);
		}
