...
namespace ACMS
{
	...
	public class FormUpdateClassAttendance : System.Windows.Forms.Form
	{
		...
		public FormUpdateClassAttendance(string membershipID)
		{
			//
			...
			myMemberPackageIDLookupEditBuilder = new ACMS.XtraUtils.LookupEditBuilder.MemberPackageIDLookupEditBuilder(lkpEdtPackageID.Properties, myMembershipID, false);
		}
