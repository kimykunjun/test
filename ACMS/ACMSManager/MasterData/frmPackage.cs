...
namespace ACMS.ACMSManager.MasterData
{
	...
	public class frmPackage : System.Windows.Forms.Form
	{
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colUseBranchCode2;
        private DevExpress.XtraGrid.Columns.GridColumn colUseBranchName2;
		private System.Windows.Forms.Label label3;
        private System.Windows.Forms.Label label7;
		private DevExpress.XtraGrid.Columns.GridColumn colBranchCode;
		private DevExpress.XtraGrid.Columns.GridColumn colBranchName;
        private DevExpress.XtraGrid.Columns.GridColumn colUseBranchCode;
        private DevExpress.XtraGrid.Columns.GridColumn colUseBranchName;
        ...
        private DevExpress.XtraEditors.SimpleButton btn_PUB_Del;
        private DevExpress.XtraEditors.SimpleButton btn_PUBAll_Del;
        private DevExpress.XtraEditors.SimpleButton btn_PUBAll_Add;
        private DevExpress.XtraEditors.SimpleButton btn_PUB_Add;
		private DevExpress.XtraGrid.GridControl gridPackageBranch2;
		private DevExpress.XtraGrid.GridControl gridPackageBranch;
        private DevExpress.XtraGrid.GridControl gridPackageUseBranch2;
        private DevExpress.XtraGrid.GridControl gridPackageUseBranch;
        ...
        private DevExpress.XtraEditors.SimpleButton btn_PGUB_Del;
        private DevExpress.XtraEditors.SimpleButton btn_PGUBAll_Del;
        private DevExpress.XtraEditors.SimpleButton btn_PGUBAll_Add;
        private DevExpress.XtraEditors.SimpleButton btn_PGUB_Add;
		private DevExpress.XtraGrid.GridControl gridPcGroupBranch2;
        private DevExpress.XtraGrid.GridControl gridPcGroupUseBranch2;
        ...
        private DevExpress.XtraGrid.GridControl gridPcGroupUseBranch;
        ...
        private DevExpress.XtraGrid.Views.Grid.GridView gvPcGroupUseBranch2;
        private DevExpress.XtraGrid.Views.Grid.GridView gvPcGroupUseBranch;
        ...
        private DevExpress.XtraGrid.Views.Grid.GridView gvPSUseBranch2;
        private DevExpress.XtraGrid.Views.Grid.GridView gvPSUseBranch;
        ...
        private DevExpress.XtraGrid.Columns.GridColumn gcPriceWGST;
        private DevExpress.XtraGrid.Columns.GridColumn gcPkgPriceWGST;
        private DevExpress.XtraGrid.Columns.GridColumn gcPkgComboPriceWGST; 
        ...
        private DevExpress.XtraGrid.Columns.GridColumn gcFreeCredit;        
        ...
        private DevExpress.XtraEditors.Repository.RepositoryItemComboBox chk_DurationUnit;
        private DevExpress.XtraGrid.Columns.GridColumn gcFreePkg;
...
//		}
		...
		{		
            ...
            else if (ddlPackageCategory.Text.ToUpper() == "SPA GIRO")
            {
                LoadPackage();
                PackageServiceDisplay();
                BindPackageService();
            }
            else if (ddlPackageCategory.Text.ToUpper() == "HOLISTIC FITNESS" || ddlPackageCategory.Text.ToUpper() == "HOLISTIC SPA")
            {
                LoadCreditPackage();
                PackageCreditDisplay();
                LoadCreditPackageRestric();
		...
		private void BindPackageClass()
		{
            ...
            strSQL = "select strBranchCode, strBranchName from TblBranch Where strBranchCode Not In (Select strBranchCode From TblPackageUseBranch Where strPackageCode = '" + dr["strPackageCode"].ToString() + "')";
            _ds = new DataSet();
            SqlHelper.FillDataset(connection, CommandType.StoredProcedure, "UP_GETDATA", _ds, new string[] { "table" }, new SqlParameter("@strSQL", strSQL));
            gridPcGroupUseBranch.DataSource = _ds.Tables["table"];
            ...
            strSQL = "select P.strPackageCode, B.strBranchCode, strBranchName from TblPackageUseBranch P Inner Join TblBranch B On B.strBranchCode = P.strBranchCode Where P.strPackageCode = '" + dr["strPackageCode"].ToString() + "'";
            _ds = new DataSet();
            SqlHelper.FillDataset(connection, CommandType.StoredProcedure, "UP_GETDATA", _ds, new string[] { "table" }, new SqlParameter("@strSQL", strSQL));
            dtUseBranch = _ds.Tables["table"];            
            gridPcGroupUseBranch2.DataSource = dtUseBranch;
        ...
        private void btn_PGUB_Add_Click(object sender, System.EventArgs e)
        {
            DataRow dr = this.gridViewMd_Package.GetDataRow(this.gridViewMd_Package.FocusedRowHandle);

            int[] rowsHandle = this.gvPcGroupUseBranch.GetSelectedRows();
            if (rowsHandle == null || rowsHandle.Length == 0)
            {
                UI.ShowErrorMessage(this, "Please select at least one row.");
                return;
            ...
            foreach (int index in rowsHandle)
            {
                DataRow rCopy = gvPcGroupUseBranch.GetDataRow(index);
                DataRow rNew = dtUseBranch.NewRow();
                rNew.BeginEdit();
                rNew["strPackageCode"] = dr["strPackageCode"];
                rNew["strBranchCode"] = rCopy["strBranchCode"];
                rNew["strBranchName"] = rCopy["strBranchName"];
                rNew.EndEdit();
                dtUseBranch.Rows.Add(rNew);
            }

            gvPcGroupUseBranch.DeleteSelectedRows();

            try
            {
                string strSQL = "select strPackageCode, strBranchCode from TblPackageUseBranch Where strPackageCode = '" + dr["strPackageCode"].ToString() + "'";
                CreateCmdsAndUpdate(strSQL, dtUseBranch);
            }
            catch (Exception)
            {
                return;
        ...
        private void btn_PGUBAll_Add_Click(object sender, System.EventArgs e)
        {
            gvPcGroupUseBranch.BeginDataUpdate();
            gvPcGroupUseBranch2.BeginDataUpdate();

            DataRow dr = this.gridViewMd_Package.GetDataRow(this.gridViewMd_Package.FocusedRowHandle);
            DataTable dtTemp = (gvPcGroupUseBranch.DataSource as DataView).Table;
            //dtTemp.RejectChanges();
            dtTemp.AcceptChanges();

            for (int i = dtTemp.Rows.Count - 1; i >= 0; i--)
            {
                DataRow rCopy = gvPcGroupUseBranch.GetDataRow(i);
                DataRow rNew = dtUseBranch.NewRow();
                rNew.BeginEdit();
                rNew["strPackageCode"] = dr["strPackageCode"];
                rNew["strBranchCode"] = rCopy["strBranchCode"];
            ...
            gvPcGroupUseBranch.EndDataUpdate();
            gvPcGroupUseBranch2.EndDataUpdate();
        ...
        private void btn_PGUBAll_Del_Click(object sender, System.EventArgs e)
        {
            DataRow dr = this.gridViewMd_Package.GetDataRow(this.gridViewMd_Package.FocusedRowHandle);
            ...
            for (int i = dtUseBranch.Rows.Count - 1; i >= 0; i--)
            {
                DataRow rCopy = gvPcGroupUseBranch2.GetDataRow(i);
                DataRow rNew = dtTemp.NewRow();
                rNew.BeginEdit();
                rNew["strBranchCode"] = rCopy["strBranchCode"];
                rNew["strBranchName"] = rCopy["strBranchName"];
            ...
            for (int i = dtUseBranch.Rows.Count - 1; i >= 0; i--)
            {
                if (dtUseBranch.Rows[i].RowState != DataRowState.Deleted)
                    dtUseBranch.Rows[i].Delete();
            }
        ...
        private void btn_PGUB_Del_Click(object sender, System.EventArgs e)
        {
            DataRow dr = this.gridViewMd_Package.GetDataRow(this.gridViewMd_Package.FocusedRowHandle);

            int[] rowsHandle = gvPcGroupUseBranch2.GetSelectedRows();
            if (rowsHandle == null || rowsHandle.Length == 0)
            {
                UI.ShowErrorMessage(this, "Please select at least one row.");
                return;
            ...
            foreach (int index in rowsHandle)
            {
                DataRow rCopy = gvPcGroupUseBranch2.GetDataRow(index);
                DataRow rNew = dtTemp.NewRow();
                rNew.BeginEdit();
                rNew["strBranchCode"] = rCopy["strBranchCode"];
                rNew["strBranchName"] = rCopy["strBranchName"];
            ...
            gvPcGroupUseBranch2.DeleteSelectedRows();
		...
		private void BindPackageService()
		{
            ...
            _ds = new DataSet();
            SqlHelper.FillDataset(connection, CommandType.StoredProcedure, "UP_GETDATA", _ds, new string[] { "table" }, new SqlParameter("@strSQL", strSQL));
            this.gridPackageUseBranch.DataSource = _ds.Tables["table"];
            ...
            SqlHelper.FillDataset(connection, CommandType.StoredProcedure, "UP_GETDATA", _ds, new string[] { "table" }, new SqlParameter("@strSQL", strSQL));
            dtUseBranch = _ds.Tables["table"];
            gridPackageUseBranch2.DataSource = dtUseBranch;
        ...
        private void btn_PUB_Add_Click(object sender, System.EventArgs e)
        {
            DataRow dr = this.gridViewMd_Package.GetDataRow(this.gridViewMd_Package.FocusedRowHandle);

            int[] rowsHandle = this.gvPSUseBranch.GetSelectedRows();
            if (rowsHandle == null || rowsHandle.Length == 0)
            {
                UI.ShowErrorMessage(this, "Please select at least one row.");
                return;
            ...
            foreach (int index in rowsHandle)
            {
                DataRow rCopy = gvPSUseBranch.GetDataRow(index);
                DataRow rNew = dtUseBranch.NewRow();
                rNew.BeginEdit();
                rNew["strPackageCode"] = dr["strPackageCode"];
                rNew["strBranchCode"] = rCopy["strBranchCode"];
            ...
            gvPSUseBranch.DeleteSelectedRows();
        ...
        private void btn_PUBAll_Add_Click(object sender, System.EventArgs e)
        {
            gvPSUseBranch.BeginDataUpdate();
            gvPSUseBranch2.BeginDataUpdate();

            DataRow dr = this.gridViewMd_Package.GetDataRow(this.gridViewMd_Package.FocusedRowHandle);
            DataTable dtTemp = (gvPSUseBranch.DataSource as DataView).Table;
            //dtTemp.RejectChanges();
            dtTemp.AcceptChanges();

            for (int i = dtTemp.Rows.Count - 1; i >= 0; i--)
            {
                DataRow rCopy = gvPSUseBranch.GetDataRow(i);
                DataRow rNew = dtUseBranch.NewRow();
                rNew.BeginEdit();
                rNew["strPackageCode"] = dr["strPackageCode"];
                rNew["strBranchCode"] = rCopy["strBranchCode"];
            ...
            gvPSUseBranch.EndDataUpdate();
            gvPSUseBranch2.EndDataUpdate();
        ...
        private void btn_PUBAll_Del_Click(object sender, System.EventArgs e)
        {
            DataRow dr = this.gridViewMd_Package.GetDataRow(this.gridViewMd_Package.FocusedRowHandle);
            ...
            for (int i = dtUseBranch.Rows.Count - 1; i >= 0; i--)
            {
                DataRow rCopy = gvPSUseBranch2.GetDataRow(i);
                DataRow rNew = dtTemp.NewRow();
                rNew.BeginEdit();
                rNew["strBranchCode"] = rCopy["strBranchCode"];
                rNew["strBranchName"] = rCopy["strBranchName"];
        ...
        private void btn_PUB_Del_Click(object sender, System.EventArgs e)
        {
            DataRow dr = this.gridViewMd_Package.GetDataRow(this.gridViewMd_Package.FocusedRowHandle);

            int[] rowsHandle = gvPSUseBranch2.GetSelectedRows();
            if (rowsHandle == null || rowsHandle.Length == 0)
            {
                UI.ShowErrorMessage(this, "Please select at least one row.");
                return;
            ...
            foreach (int index in rowsHandle)
            {
                DataRow rCopy = gvPSUseBranch2.GetDataRow(index);
                DataRow rNew = dtTemp.NewRow();
                rNew.BeginEdit();
                rNew["strBranchCode"] = rCopy["strBranchCode"];
                rNew["strBranchName"] = rCopy["strBranchName"];
            ...
            gvPSUseBranch2.DeleteSelectedRows();
