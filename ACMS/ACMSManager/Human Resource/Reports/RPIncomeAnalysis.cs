	...
	public class RPIncomeAnalysis : System.Windows.Forms.Form
	{
		...
		private void BindReport()
		{
			...
			//{
				...
				try
				{
					CurrentGridIncomeAnalysis.DataSource = dtCurrentMonthSales;//1503
				}
				catch(Exception ex)
				{
			...
			PrevGridIncomeAnalysis.DataSource = dtPrevTwoSales;//1503
				...
				ThirdGridIncomeAnalysis.DataSource = dtPrevTenDaysSales;//1503
