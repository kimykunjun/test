...
namespace ACMS.ACMSManager.Reports
{
	...
	public class RPClassInstructor : System.Windows.Forms.Form
	{
		...
		public RPClassInstructor(int empId)
		{
            ...
            {
                cbYear.Properties.Items.Add(new DevExpress.XtraEditors.Controls.ImageComboBoxItem(i.ToString(), i, -1));
            }
            //cbYear.EditValue = 2013;
		...
		private void InitializeComponent()
		{
            ...
            // cbYear
            // 
            this.cbYear.EditValue = thisYear;
		...
		private void ScheduleHeader()
		{
            ...
            //if (WeekNo==53 && selectedYear ==DateTime.Now.Year.ToString()) //jackie 2018
            if (WeekNo > 53 && selectedYear == DateTime.Now.Year.ToString()) //jackie 2018
				WeekNo=1;
