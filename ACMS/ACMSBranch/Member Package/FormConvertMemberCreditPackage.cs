...
namespace ACMS
{
	...
	/// </summary>
	public class FormConvertMemberCreditPackage : System.Windows.Forms.Form
	{
        ...
        public FormConvertMemberCreditPackage(string strCurrMemberID, string strReceiptNo)
		{
			//
            ...
            txtPackage.Text = strReceiptNo;
			myCurrMemberID = strCurrMemberID;
			//myPackageID = packageID;
            //myMemberPackageSession = nSession;
            labelHeader.Text = string.Format("Convert Credit Receipt = {0} of Member {1}.", strReceiptNo, strCurrMemberID);
            // calcualte converted amount (pay amount - usage amount)
            CalculateAmount(strReceiptNo);
            //CalculateUsage();
        ...
        private void CalculateAmount(string strReceipt)
        {

            mPayAmount = GetTotalPayment(strReceipt);
