...
{
	/// <summary>
	/// Summary description for frmSRMerge.
	/// </summary>
	public class frmSRMerge : System.Windows.Forms.Form
	{
		private string connectionString;
		private SqlConnection connection;
		private System.Windows.Forms.Label label1;
		private DevExpress.XtraEditors.RadioGroup RGMerge;
		private DevExpress.XtraGrid.GridControl gridMerge;
		...
		private void InitializeComponent()
		{
            ...
            this.RGMerge = new DevExpress.XtraEditors.RadioGroup();
            this.gridMerge = new DevExpress.XtraGrid.GridControl();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.RGMerge.Properties)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.gridMerge)).BeginInit();
            ...
            this.label1.Text = "Ranking of Merge Sales";
            this.label1.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
            // 
            // RGMerge
            // 
            this.RGMerge.EditValue = 0;
            this.RGMerge.Location = new System.Drawing.Point(0, 64);
            this.RGMerge.Name = "RGMerge";
            this.RGMerge.Properties.Appearance.BackColor = System.Drawing.Color.Transparent;
            this.RGMerge.Properties.Appearance.Font = new System.Drawing.Font("Tahoma", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.RGMerge.Properties.Appearance.Options.UseBackColor = true;
            this.RGMerge.Properties.Appearance.Options.UseFont = true;
            this.RGMerge.Properties.BorderStyle = DevExpress.XtraEditors.Controls.BorderStyles.NoBorder;
            this.RGMerge.Properties.Columns = 2;
            this.RGMerge.Properties.Items.AddRange(new DevExpress.XtraEditors.Controls.RadioGroupItem[] {
            ...
            this.RGMerge.Size = new System.Drawing.Size(496, 32);
            this.RGMerge.TabIndex = 10;
            this.RGMerge.EditValueChanged += new System.EventHandler(this.RGMerge_EditValueChanged);
            this.RGMerge.Click += new System.EventHandler(this.RGMerge_Click);
            // 
            // gridMerge
            // 
            this.gridMerge.Dock = System.Windows.Forms.DockStyle.Bottom;
            this.gridMerge.Location = new System.Drawing.Point(0, 96);
            this.gridMerge.MainView = this.gridView2;
            this.gridMerge.Name = "gridMerge";
            this.gridMerge.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.lk_Employee});
            this.gridMerge.Size = new System.Drawing.Size(960, 384);
            this.gridMerge.TabIndex = 9;
            this.gridMerge.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gridView2});
            // 
            // gridView2
            // 
            ...
            this.SalesTotal});
            this.gridView2.GridControl = this.gridMerge;
            ...
            this.Controls.Add(this.RGMerge);
            this.Controls.Add(this.gridMerge);
            this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
            this.Name = "frmSRMerge";
            this.Text = "frmSRMerge";
            this.Load += new System.EventHandler(this.frmSRMerge_Load);
            ((System.ComponentModel.ISupportInitialize)(this.RGMerge.Properties)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.gridMerge)).EndInit();
		...
		private void BindReport(System.EventArgs e)
		{
			...
			if (IsFinishedInit)
			{
				...
				{
					_ds = new DataSet();
                    _ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "UP_ComSalesRankMerge", 
					...
					gridMerge.DataSource = DTSalesRank;
					RGMerge_EditValueChanged(this,e);
				}
				catch(Exception ex)
                {
        ...
        private void frmSRMerge_Load(object sender, System.EventArgs e)
        {
            BindCalendar();
        ...
        private void RGMerge_EditValueChanged(object sender, System.EventArgs e)
        {

            i = 1;
            if (RGMerge.SelectedIndex == 0)
            {
        ...
        private void RGMerge_Click(object sender, System.EventArgs e)
        {
            i = 1;
        }
