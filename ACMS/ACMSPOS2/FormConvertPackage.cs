...
{
	/// <summary>
	/// Summary description for FormConvertPackage.
	/// </summary>
	public class FormConvertPackage : System.Windows.Forms.Form
	{
		...
		public FormConvertPackage(ACMSLogic.POS pos)
		{
			//
		...
		private void Init()
		{
			...
			myDataView = myMemberPackage.GetActive_n_NonFreeMemberPackage_Convert_Calculation(myPOS.StrMembershipID);
		...
		private void InitializeComponent()
		{
            ...
            this.label1.Text = "Convert Package";
            // 
            ...
            this.GridControlMemberPackage.LevelTree.Nodes.AddRange(new DevExpress.XtraGrid.GridLevelNode[] {
            gridLevelNode1});
            ...
            // GridColumn34
            // 
            this.GridColumn34.Caption = "Balance Usage";
            ...
            // GridColumn45
            // 
            this.GridColumn45.Caption = "Base UnitPrice";
            this.GridColumn45.FieldName = "mbaseunitprice";
            ...
            this.splitterControl1.Size = new System.Drawing.Size(864, 6);
            ...
            this.panelControlPackage.Size = new System.Drawing.Size(864, 528);
            ...
            this.simpleButtonOK1.Location = new System.Drawing.Point(692, 502);
            ...
            this.Name = "FormConvertPackage";
            this.ShowInTaskbar = false;
            this.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Show;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Upgrade Selection";
            this.Load += new System.EventHandler(this.FormConvertPackage_Load);
		...
		private void gridViewMemberPackage_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
		{
			...
			if (r != null)
			{
                ...
                decimal BaseUnitPrice = ACMS.Convert.ToDecimal(r["mBaseUnitPrice"]);
                DataTable table = myPackage.GetAllValidConvertPackage(strPackageCode, BaseUnitPrice);
		...
		private void simpleButtonOK_Click(object sender, System.EventArgs e)
		{
			...
			if (r != null)
			{
				...
				myPOS.NewReceiptEntryForConvert(rowToAdd, r);
			}
		}
		...
		private void gridViewMemberPackage_CustomColumnDisplayText(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventArgs e)
		{
			if (e.Column.FieldName == "Balance")
			{
					...
					ACMS.Convert.ToInt32(myDataView.Table.Rows[e.ListSourceRowIndex]["Balance"]) == 0)
				{
                    ...
                    e.DisplayText = "New"; //04/03/2012 jackie
				}
			}
		}
        ...
        private void FormConvertPackage_Load(object sender, System.EventArgs e)
        {
