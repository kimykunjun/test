...
namespace ACMS.ACMSPOS2
{
	...
	public class FormAddBillFreebie : System.Windows.Forms.Form
	{
				...
				lkpEdtPromotionCode.Text != "")
			{
                ...
                //{
                    ...
                    if (table != null)
                    {
                        ...
                        if (!table.Columns.Contains("nQuantity"))
                        {
                ...
                //{
                    ...
                    DataTable tablepkg = package.GetPromotionPackageBasePromotionCode(strPromotionCode);

                    if (tablepkg != null)
                    {
                        if (!tablepkg.Columns.Contains("Checked"))
                        {
                            DataColumn colChecked = new DataColumn("Checked", typeof(bool));
                            tablepkg.Columns.Add(colChecked);
                        }

                        if (!tablepkg.Columns.Contains("nQuantity"))
                        {
                            DataColumn colQty = new DataColumn("nQuantity", typeof(int));
                            tablepkg.Columns.Add(colQty);
                        }

                        foreach (DataRow r in tablepkg.Rows)
                        {
                            r["Checked"] = false;
                            r["nQuantity"] = 1;
                        }
                    ...
                    gridControl1.DataSource = tablepkg;
                //}
			}
		}
        ...
        private bool ValidatePackageQty()
        {
