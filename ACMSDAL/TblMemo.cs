///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'tblMemo'
...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'tblMemo'.
	/// </summary>
	public class TblMemo : DBInteractionBase
	{
		#region Class Member Declarations
			private SqlDateTime		_dtLastEditDate, _dtDate;
			private SqlInt32		_nEmployeeID, _nEmployeeIDOld, _nMemoID, _nStatusID;
			private SqlString		_strTitle, _strMessage;
		#endregion
		...
		public override bool Insert()
		{
			...
			cmdToExecute.CommandText = "dbo.[sp_tblMemo_Insert]";
			...
			try
			{
				...
				cmdToExecute.Parameters.Add(new SqlParameter("@sstrTitle", SqlDbType.VarChar, 255, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _strTitle));
				...
				cmdToExecute.Parameters.Add(new SqlParameter("@inMemoID", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _nMemoID));
				...
				_nMemoID = (SqlInt32)cmdToExecute.Parameters["@inMemoID"].Value;
				_errorCode = (SqlInt32)cmdToExecute.Parameters["@iErrorCode"].Value;

				if(_errorCode != (int)LLBLError.AllOk)
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblMemo_Insert' reported the ErrorCode: " + _errorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("TblMemo::Insert::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[sp_tblMemo_Update]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblMemo_Update' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("TblMemo::Update::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[sp_tblMemo_UpdateAllWnEmployeeIDLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblMemo_UpdateAllWnEmployeeIDLogic' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("TblMemo::UpdateAllWnEmployeeIDLogic::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[sp_tblMemo_Delete]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblMemo_Delete' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("TblMemo::Delete::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[sp_tblMemo_DeleteAllWnEmployeeIDLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblMemo_DeleteAllWnEmployeeIDLogic' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("TblMemo::DeleteAllWnEmployeeIDLogic::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[sp_tblMemo_SelectOne]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("tblMemo");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblMemo_SelectOne' reported the ErrorCode: " + _errorCode);
				}
				...
				if(toReturn.Rows.Count > 0)
				{
					...
					_strTitle = toReturn.Rows[0]["strTitle"] == System.DBNull.Value ? SqlString.Null : (string)toReturn.Rows[0]["strTitle"];
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("TblMemo::SelectOne::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[sp_tblMemo_SelectAll]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("tblMemo");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblMemo_SelectAll' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("TblMemo::SelectAll::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[sp_tblMemo_SelectAllWnEmployeeIDLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("tblMemo");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblMemo_SelectAllWnEmployeeIDLogic' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("TblMemo::SelectAllWnEmployeeIDLogic::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
