///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'tblSize'
...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'tblSize'.
	/// </summary>
	public class TblSize : DBInteractionBase
	{
		#region Class Member Declarations
			private SqlString		_strDescription, _strSizeCode;
		#endregion
		...
		public override bool Insert()
		{
			...
			cmdToExecute.CommandText = "dbo.[sp_tblSize_Insert]";
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblSize_Insert' reported the ErrorCode: " + _errorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("TblSize::Insert::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[sp_tblSize_Update]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblSize_Update' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("TblSize::Update::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[sp_tblSize_Delete]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblSize_Delete' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("TblSize::Delete::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[sp_tblSize_SelectAll]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("tblSize");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'sp_tblSize_SelectAll' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("TblSize::SelectAll::Error occured.", ex);
			}
			finally
			{
				if(_mainConnectionIsCreatedLocal)
