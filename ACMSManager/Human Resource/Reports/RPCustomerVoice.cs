...
namespace ACMS.ACMSManager.Reports
{
	...
	public class RPCustomerVoice : System.Windows.Forms.Form
	{
		...
		private void BindReport()
		{
			...
			string str = string.Format("dtDate >= '{0}' And dtDate < '{1}'",string.Format("{0:yyyy-MM-dd}",Convert.ToDateTime(DateFrom.EditValue)),string.Format("{0:yyyy-MM-dd}",Convert.ToDateTime(DateRangeTo.EditValue)));
			dv.RowFilter = str;
