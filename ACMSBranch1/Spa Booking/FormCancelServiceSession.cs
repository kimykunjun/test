...
namespace ACMS
{
	...
	/// </summary>
	public class FormCancelServiceSession : System.Windows.Forms.Form
	{
		...
		public FormCancelServiceSession(int nSessionID, string strMemberName)
		{
			//
			...
			label1.Text = string.Format("Do you really want to delete" + "\n Service Session ID :{0}, Member Name : {1}", 
				nSessionID.ToString(), strMemberName);
		}
		...
		private void InitializeComponent()
		{
			...
			this.Name = "FormCancelServiceSession";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Delete Service Session";
