...
{
	/// <summary>
	/// Summary description for frmSRFitnessPackage.
	/// </summary>
	public class frmSRFitnessPackage : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.RGFitnessPackage.Properties.Appearance.Font = new System.Drawing.Font("Tahoma", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
		...
		private void BindReport(System.EventArgs e)
		{
			...
			if (IsFinishedInit)
			{
				...
				{
					_ds = new DataSet();
					_ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "UP_ComSalesRankFitnessPack", 
					...
					gridFitnessPackage.DataSource = DTSalesRank;
					RGFitnessPackage_EditValueChanged(this,e);
				}
				catch(Exception ex)
                {
		...
		private void RefreshGrid()
		{
			...
			gridFitnessPackage.DataSource = dv;
		}
		...
		private void frmSRFitnessPackage_Load(object sender, System.EventArgs e)
		{
			BindCalendar();
		...
		private void RGFitnessPackage_EditValueChanged(object sender, System.EventArgs e)
		{
		...
		private void RGFitnessPackage_Click(object sender, System.EventArgs e)
		{
			i = 1;
		}
