...
namespace ACMS.ACMSStaff.Memo
{
	...
	public class frmNewMemo2 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtSubject.Size = new System.Drawing.Size(678, 22);
			...
			this.groupControl1.Location = new System.Drawing.Point(4, 142);
			...
			this.sbtnDraft.Location = new System.Drawing.Point(678, 530);
			...
			this.sbtnSend.Location = new System.Drawing.Point(760, 530);
			...
			this.sbtnCancel.Location = new System.Drawing.Point(842, 530);
		...
		private void sbtnSend_Click(object sender, System.EventArgs e)
		{
			...
			if (!myMemo.SaveNewMemo(txtSubject.Text, memoedtBody.Text, nEmployeeID, ACMSLogic.Staff.MemoStatusID.Active,
		...
		private void sbtnDraft_Click(object sender, System.EventArgs e)
		{
			...
			if (!myMemo.SaveNewMemo(txtSubject.Text, memoedtBody.Text, nEmployeeID, ACMSLogic.Staff.MemoStatusID.Draft,
				dtBranch, dtDepartmentGroup, dtPersonalGroup, dtEmployee))
			{
				UI.ShowErrorMessage(this, "Memo failed to save.");
			}
