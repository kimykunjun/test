...
namespace ACMSLogic.Report
{
	...
	/// </summary>
	public class MemberPackageExpiryReport : DevExpress.XtraReports.UI.XtraReport
	{
		...
		public MemberPackageExpiryReport()
		{
			//
		...
		public void CreateDataBindings()
		{
			...
			xrlblPackageCode.DataBindings.Add("Text", DataSource, "strPackageCode");
			xrlblPackageID.DataBindings.Add("Text", DataSource, "nPackageID");
